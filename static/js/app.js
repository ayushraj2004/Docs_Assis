...
function toggleMic() {
  ...
  if (!SpeechRecognition) { showToast('Microphone not supported in this browser', 'error'); return; }
  ...
  icon.className = 'fa-solid fa-microphone-lines text-sm';
